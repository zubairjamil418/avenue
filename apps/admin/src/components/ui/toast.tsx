...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Close
    ref={ref}
    className={cn(
      "absolute right-1 top-1 rounded-md p-1 text-foreground/50 opacity-0 transition-opacity hover:text-foreground focus:opacity-100 focus:outline-hidden focus:ring-1 group-hover:opacity-100 group-[.destructive]:text-error-light hover:group-[.destructive]:text-error-lighter focus:group-[.destructive]:ring-error-main focus:group-[.destructive]:ring-offset-red-600",
      className
    )}
    toast-close=""
    {...props}
